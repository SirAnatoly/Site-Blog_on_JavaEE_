...
<div id="new-comment-container" class="media-object comment-item new-comment">
    <div class="media-object-section">
        <img class="avatar" src="/Site_Blog_on_JavaEE_war/static/img/no_avatar.png" alt="anonym" /><br/>
...
<div id="new-comment-loading" class="row column text-center">
    <img src="/Site_Blog_on_JavaEE_war/static/img/loading.gif" alt="Loading..." class="loading-indicator" style="margin:12px auto;"/>
</div>
